...
# --- Konfigurācija ---
st.set_page_config(
    page_title="Llama OCR - teksta izvilkšana v7",
    page_icon="🛒",
    layout="wide",
...
# UI
st.title("🖼️ Teksta izvilkšana no attēliem - v7")
...
with st.sidebar:
    ...
    merchant = st.selectbox("🏪 Tirgotājs", ["MAXIMA", "RIMI", "LIDL", "TOP", "ELVI", "DEPO", "NARVESEN"], index=0)
